...
for i in range(1,a+1):
  if(rev):
    b="Jugs" *bool((i%3==0)|('3' in str(i)))
    b="Mugs" *bool((i%5==0)|('5' in str(i)))+b
    b="Pugs" *bool((i%7==0)|('7' in str(i)))+b
    print(b or i)
  else:
    print("Jugs" *((i%3==0)|('3' in str(i)))+"Mugs" *((i%5==0)|('5' in str(i)))+"Pugs" *((i%7==0)|('7' in str(i))))
```
